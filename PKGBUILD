...
arch=('x86_64' 'i686')
url='https://github.com/boukehaarsma23/amd_energy'
license=('GPL2')
depends=('dkms')
provides=('amd_energy-dkms')
...
package() {
  ...
  install -Dm644 "$srcdir/$_pkgname/amd_energy.c" "$pkgdir/usr/src/$_pkgname-$pkgver/amd_energy.c"
}
